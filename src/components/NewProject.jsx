...
export default function NewProject({addProject,onCancel}){
    ...
    function handleSave(){
        ...
        if(projtitle.trim() === '' || projdesc.trim() === '' || projdue.trim() === ''){
            modal.current.open();
            return;
        }
    ...
    <div className="w-[35rem] mt-16">
        <menu className="flex items-center justify-end gap-4 my-4">
            ...
            <li><button onClick={handleSave} className="px-2 py-2 rounded-md bg-stone-800 text-stone-50 hover:bg-stone-950">Save</button></li>
        </menu>
        <div>
